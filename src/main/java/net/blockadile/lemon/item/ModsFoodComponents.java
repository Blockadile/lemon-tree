...
public class ModsFoodComponents {
    ...
    public static final FoodComponent GRAPEFRUIT = new FoodComponent.Builder().nutrition(4).saturationModifier(0.75f).build();
    public static final FoodComponent GRAPEFRUIT_SLICE = new FoodComponent.Builder().nutrition(2).saturationModifier(0.5f).build();
